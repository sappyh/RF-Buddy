...
class top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/saptarshi/Desktop/RF-Buddy/Dataset/node-25.sigmf-data', False, 0, 0)
        ...
        self.annotator_packet_annotator_0 = annotator.packet_annotator(25, 1)
        self.sigmf_sink_0 = gr_sigmf.sink(
            "cf32", 'node-25', gr_sigmf.sigmf_time_mode_relative, False)
        ...
        self.msg_connect((self.annotator_packet_annotator_0,'annotations'), (self.sigmf_sink_0, 'command'))
        self.msg_connect((self.IEEE154RX_0, 'rxout'),(self.annotator_packet_annotator_0, 'message'))
